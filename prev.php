	...
	<div class="men_banner">
	   ...
	   <div class="menu">
	     ...
	     <ul class="megamenu skyblue">
	     	<li class="active grid" style="color: white"><a href = "customer.php">Home</a></li>
...
<?php
$Query="select ocat,odet,ostore,oquan,ostatus,sid from orders where cid='$login_id'";
